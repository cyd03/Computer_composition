  ...
  /******         Control Signal              ******/
   always @(*) begin
     ...
     case (state)
         ...
         sexe: begin
           ALUOp[0] = i_add | i_lw | i_sw | i_addi | i_and | i_slt | i_addu | i_nor | i_lui | i_slti | i_andi ;
           ALUOp[1] = i_sub | i_beq | i_and | i_sltu | i_subu | i_nor | i_bne | i_andi | i_srl | i_srlv;
           ALUOp[2] = i_or | i_ori | i_slt | i_sltu | i_nor | i_slti;
           ALUOp[3] = i_sll | i_lui | i_srl | i_sllv | i_srlv;
           if (i_beq | i_bne) begin
             ...
             ALUSrcB = 2'b00;
             nextstate = swb;
           end else if (i_nor | i_sllv | i_srlv)begin
             ALUSrcA = 2'b01;
             ALUSrcB = 2'b00;
             nextstate = swb;
